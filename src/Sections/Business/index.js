...
const Business = () => {
  ...
  useEffect(() => {
    ...
    const t1 = gsap.timeline({
      scrollTrigger: {
        trigger: document.getElementById("business"),
  ...
  return (
    <BusinessSection id="business">
      <BusinessBackground ref={ref}>
        <BusinessTitle style={{ textAlign: "center"}} className="business-title">ORO Business Group is primarily composed of the following</BusinessTitle>
        <Line id="line" />
